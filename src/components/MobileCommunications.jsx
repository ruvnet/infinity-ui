...
import { Inbox, Send, Star, AlertTriangle, Trash2, ChevronLeft, Menu, X, Plus, Eye, Edit, Trash } from 'lucide-react';
  ...
  const renderMessageList = () => (
    ...
    >
      ...
      <div className="flex justify-around items-center p-2 bg-[#b73616]/80 border-t border-[#ffd0a8]/20">
        <button className="text-[#ffd0a8] p-2 hover:bg-[#ffd0a8]/10 rounded-full transition-colors">
          <Plus size={24} />
        </button>
        <button className="text-[#ffd0a8] p-2 hover:bg-[#ffd0a8]/10 rounded-full transition-colors">
          <Eye size={24} />
